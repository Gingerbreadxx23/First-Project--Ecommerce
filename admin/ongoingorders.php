<h3  class = "my-3">Ongoing Orders</h3>
<?php 
       require('./includes/database.php');
      $queryviewPendingOrders ="SELECT * FROM `orders` WHERE `order_status` = 'shipped';";
         ...
         <?php 
          ...
          <div class="d-flex  mb-3">
              ...
              <div class="p-3 mt-5 ">
                ...
                <input type= "hidden" name="complete-id" value = <?php echo  $orderID;?>>
                <input type="submit" style="width:150px; height:45px;"  name="complete" class="btn btn-success " value="Complete"/> <br>
               </form>

               <form action="" method ="post">
              <input type="submit" style="width:150px; height:45px;" name="order-receipt" class="btn btn-warning mt-4 " value="Order Receipt"/><br>
              </form>
              </div>
          </div>
          </div> 

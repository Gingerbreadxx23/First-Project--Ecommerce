         ...
         <?php 
          ...
          <div class="d-flex  mb-3">
              ...
              <div class="p-3 ">
                ...
                <input type= "hidden" name="process-id" value = <?php echo  $orderID;?>>
                <input type="submit" style="width:150px; height:45px;"  name="process" class="btn btn-success  mt-3" value="Process"/> <br>
               </form>

               <form action="orders.php" method ="post">
               <input type= "hidden" name="cancel-id" value = <?php echo  $orderID;?>>
               <input type="submit" style="width:150px; height:45px;" name="cancel" class="btn btn-danger mt-3 " value="Cancel"/><br>
               </form>
